                    ...
                    <div className="text-center space-y-8 relative z-10">
                        ...
                        >
                            <h2 className="text-4xl md:text-6xl font-display font-black text-white leading-tight">
                                ...
                                <span className="text-brand-gold">Next Big Vision?</span>
                            </h2>
                        ...
                        >
                            <div className="text-center">
                                <p className="text-white font-bold block text-2xl">50+</p>
                                <p className="text-xs uppercase tracking-widest text-gray-500 font-bold">Projects</p>
                            </div>
                            <div className="h-10 w-px bg-white/10" />
                            <div className="text-center">
                                <p className="text-white font-bold block text-2xl">100%</p>
                                <p className="text-xs uppercase tracking-widest text-gray-500 font-bold">Safe</p>
                            </div>
                            <div className="h-10 w-px bg-white/10" />
                            <div className="text-center">
